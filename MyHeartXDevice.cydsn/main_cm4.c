...
/* Function used to check low power readiness of the system */
...
int main(void)
{
    ...
    for(;;)
    {
        ...
        /* process BLE events and handle custom BLE services */
        BleProcessEvent(); 
    }
}

/*******************************************************************************
* Function Name: static void EnterLowPowerMode(void)
********************************************************************************
* Summary:
*  Function used to check low power readiness of the system
*
...
static void EnterLowPowerMode(void)
{
    if((Ble_LowPowerReadiness()) && 
       (RgbLed_LowPower_Readiness()) &&  
        Uart_LowPower_Readiness())
    {
